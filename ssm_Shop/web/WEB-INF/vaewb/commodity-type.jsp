                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage ">
                                <a style="text-decoration:none"href="javascript:;"  onclick="xadmin.add_tab('属性列表','brand.html')">
                                    <i class="layui-icon">属性列表</i>
                                </a>
                                <a title="编辑" href="javascript:;" onclick="xadmin.open('编辑','commodity-type-add.jsp','800','510','1')"
