                    ...
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑" href="javascript:;" onclick="xadmin.open('编辑','articletypeadd.jsp','800','510','1')"
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑" href="javascript:;" onclick="member_add('编辑','articletypeadd.jsp','800','500','510')"
                                   class="ml-5" style="text-decoration:none">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>
