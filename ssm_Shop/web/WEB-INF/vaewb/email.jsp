...
<head>
    ...
    <link rel="stylesheet" href="../../bgstatics/css/main.css">
    ...
    <div class="row">
        <div class="email-edge col-lg-2">
            ...
            <dl class="email-folder">
                <dt>文件夹</dt>
                <dd>
                    <a href="javascript:;" data-url="email-list.html"><i class="iconfont">&#xe69b;</i>收件箱<span class="layui-badge f-r">12</span></a>
                </dd>
                <dd>
                    <a href="javascript:;" data-url="email-list.html"><i class="iconfont">&#xe69f;</i>发信<span class="layui-badge layui-bg-cyan f-r">6</span></a>
                </dd>
                <dd>
                    <a href="javascript:;" data-url="email-list.html"><i class="iconfont">&#xe6a2;</i>草稿<span class="layui-badge layui-bg-blue f-r">2</span></a>
                </dd>
                <dd>
                    <a href="javascript:;" data-url="email-list.html"><i class="layui-icon">&#xe640;</i><span class="layui-badge layui-bg-green f-r">4</span>垃圾箱</a>
                </dd>
            </dl>
                    ...
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            ...
                            <div class="layui-card-header">
                                ...
                                <!--<button class="layui-btn" onclick="xadmin.open('添加用户','./articleadd.jsp',800,600)"><i class="layui-icon"></i>添加</button>-->
                            </div>
