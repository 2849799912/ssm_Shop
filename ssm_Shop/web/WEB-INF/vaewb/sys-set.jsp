...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../bgstatics/css/index.css" media="all">
    </head>
    <body>
        <div class="x-nav">
                ...
                <div class="layui-tab-item layui-show">
                    <form class="layui-form layui-form-pane" action="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="title" autocomplete="off" placeholder="&copy; 2017 风羽"
                                class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="title" autocomplete="off" placeholder="ICP备xxxxxxx号"
                                class="layui-input">
                            </div>
                        </div>
