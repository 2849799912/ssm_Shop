        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加团购','./discount-add.html',800,600)">
                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td>手机优惠活动</td>
                            <td>2020-7-7 21:22:44</td>
                            <td>2020-7-7 21:22:44</td>
                            <td>450</td>
                            <td>5000</td>
                            <td>50</td>
                            <td class="td-manage">
                                <a title="查看" onclick="xadmin.open('编辑','discount-add.html')" href="javascript:;">
