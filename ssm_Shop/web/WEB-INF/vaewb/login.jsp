...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/bgstatics/css/login.css">
...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up" style="margin: 50px auto">
        <div class="message">管理登录</div>
        <div id="darkbannerwrap"></div>
        
        <form method="post" class="layui-form" action="${pageContext.request.contextPath}/user/bglong.do">
