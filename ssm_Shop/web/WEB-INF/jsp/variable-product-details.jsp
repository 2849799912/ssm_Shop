                    ...
                    <div class="col-lg-7 col-custom">
                        <div class="product-summery position-relative">
                            <div class="product-head mb-3">
                                <h2 class="product-title">产品标题</h2>
                            </div>
                            ...
                            <div class="product-meta">
                                ...
                                <div class="product-material mb-4">
                                    <span>材料 :</span>
                                    <a href="#"><strong>金属</strong></a>
                                    <a href="#"><strong>树脂</strong></a>
                                    <a href="#"><strong>皮革</strong></a>
                                    <a href="#"><strong>渣</strong></a>
                                </div>
                            </div>
                            <div class="quantity-with_btn mb-4">
                                ...
                                <div class="add-to_cart">
                                    ...
                                    <a class="btn obrien-button-2 treansparent-color pt-0 pb-0" href="wishlist.html">加入意愿清单</a>
                                </div>
                            </div>
                        ...
                        <div class="tab-content mb-text" id="myTabContent">
                            <div class="tab-pane fade show active" id="connect-1" role="tabpanel" aria-labelledby="home-tab">
                                <div class="desc-content">
                                    <p class="mb-3">另一方面，我们以正义的义愤谴责和厌恶那些被一时的快乐的魅力所迷惑和堕落的人，他们被欲望所蒙蔽，无法预见必然随之而来的痛苦和麻烦;那些因意志薄弱而不履行职责的人，也应受到同样的责备，这就好比说因劳苦和痛苦而退缩。这些案例非常简单，很容易区分。 在一个自由的时刻，当我们的选择的力量不受约束，当没有什么可以阻止我们做我们最喜欢的事情时，每一种快乐都是受欢迎的，每一种痛苦都是被避免的。但在某些情况下，由于责任或业务上的义务，常常会出现这样的情况:不得不拒绝快乐，接受烦恼。因此，明智的人在这些事情上总是坚持选择的原则:他拒绝快乐以获得其他更大的快乐，或者他忍受痛苦以避免更大的痛苦。</p>
                                        ...
                                        <div class="pro_review mb-5">
                                            ...
                                            <div class="review_details">
                                                <div class="review_info mb-2">
                                                    ...
                                                    <h5>作者 - <span> 2020年12月19日</span></h5>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="connect-3" role="tabpanel" aria-labelledby="contact-tab">
                                <div class="shipping-policy">
                                    ...
                                    <p class="desc-content mb-2">没有选择余地的情况下，我要给你一个最好的答复。打字不清晰;这是传说中的事</p>
